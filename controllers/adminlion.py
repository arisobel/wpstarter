...
def users_manage():
    ...
    return dict(form_users=DIV(form_users,_class='well'))
#=====================================================================
# funcao de Users Manage
#=====================================================================
...
# Armazena o ID do grupo
    ...
    return dict(form_user_editar=DIV(form_user_editar,_class='well'), form_grupos=form_grupos)
#=====================================================================
...
# Armazena o ID do grupo
    ...
    form_grupos_menu = LOAD(c='adminlion',
                 ...
                 content='Aguarde, carregando...',
                 target='lista_users',
                 ajax=True) if id_menu <> 0 else "Primeiro cadastre o User"

    return dict(form_menu_editar=DIV(form_menu_editar,_class='well'), form_grupos_menu=form_grupos_menu)
